...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  if (locale === "zh") {
    return { title: "AI出口产品情报", description: "发现出口机会、评估目标市场、比较产品并查询BTKI参考。" };
  }
  return { title: "AI Export Product Intelligence", description: "Discover export opportunities, assess target markets, compare products, and open BTKI references in one intelligence workspace." };
}
